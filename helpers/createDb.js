...
con.query(
  "CREATE TABLE IF NOT EXISTS `users` (`user_id` int(5) NOT NULL AUTO_INCREMENT, `email` varchar(255) NOT NULL,   `user_name` varchar(20) NOT NULL, `password` varchar(255) NOT NULL , `avatar` varchar(255) ,PRIMARY KEY (`user_id`)  ) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;"
  , function (err, result) {
if (err) throw err;
